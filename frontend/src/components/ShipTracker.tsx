    ...
    return (
        <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="px-4 py-3 border-b flex items-center justify-between" style={{ borderColor: 'rgba(207,201,194,0.10)' }}>
                <h2 className="font-display text-text-light text-sm tracking-tight">INDIAN OCEAN — VESSEL TRACKING</h2>
                <div className="flex items-center gap-2">
                    ...
                    <span className="mono-label text-text-light/50">{stats.total} VES</span>
                </div>
            </div>
            ...
            {!apiKeySet && (
                <div className="mx-3 mt-3 p-3 bg-amber-500/10 border border-amber-500/30">
                    ...
                    <p className="mono-label text-text-light/50 mt-1">
            ...
            <div className="flex divide-x divide-bg-dark/10 px-2 py-2">
                {[
                    ...
                    <div key={s.label} className="px-3 text-center">
                        <div className={`font-mono text-sm font-bold ${s.red && s.value > 0 ? 'text-amber-400' : 'text-text-light'}`}>{s.value}</div>
                        <div className="mono-label text-text-light/40 text-[10px]">{s.label}</div>
                    </div>
                ))}
            </div>
            ...
            <div className="flex-1 overflow-y-auto px-3 pb-2">
                ...
                {vessels.length === 0 && (
                    <div className="text-center py-8 mono-label text-text-light/30">
