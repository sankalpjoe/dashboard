...
export function CompanyIntelligencePanel() {
  const [searchInput, setSearchInput] = useState("goldmansachs.com");
  const [activeSearch, setActiveSearch] = useState<{ domain?: string; name?: string } | null>({ domain: "goldmansachs.com" });
