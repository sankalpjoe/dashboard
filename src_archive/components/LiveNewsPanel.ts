...
// Full variant: India-focused live news channels (24/7 live streams)
const FULL_LIVE_CHANNELS: LiveChannel[] = [
  { id: 'ndtv', name: 'NDTV 24x7', handle: '@NDTV', fallbackVideoId: 'MN8p-Tn_jKU' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'times-of-india', name: 'Times of India', handle: '@TimesofIndia', fallbackVideoId: 'GlBCv2WRjTQ' },
  { id: 'republic', name: 'Republic', handle: '@republic', fallbackVideoId: 'HpHgPyKGlso' },
];
