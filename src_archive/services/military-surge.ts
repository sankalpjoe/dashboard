...
const POSTURE_THEATERS: PostureTheater[] = [
  ...
  },
  {
    ...
    shortName: 'HIMALAYAS',
    targetNation: 'China',
    regions: ['ladakh', 'arunachal', 'doklam'],
    bounds: { north: 37, south: 26, east: 98, west: 74 },
    thresholds: { elevated: 5, critical: 12 },
    navalThresholds: { elevated: 0, critical: 0 }, // Landlocked theater
    strikeIndicators: { minTankers: 1, minAwacs: 1, minFighters: 4 },
  },
  {
    id: 'indian-ocean',
    ...
    shortName: 'IOR',
    targetNation: null,
    regions: ['andaman-sea', 'arabian-sea', 'bay-of-bengal'],
    bounds: { north: 25, south: -5, east: 100, west: 60 },
    thresholds: { elevated: 4, critical: 10 },
    navalThresholds: { elevated: 4, critical: 8 },
    strikeIndicators: { minTankers: 1, minAwacs: 1, minFighters: 3 },
  },
];
