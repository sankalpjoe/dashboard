...
export const CURATED_COUNTRIES: Record<string, CuratedCountryConfig> = {
  ...
  IN: {
    name: 'India',
    scoringKeywords: ['india', 'delhi', 'modi', 'mumbai', 'bangalore', 'kashmir', 'ladakh', 'manipur', 'arunachal', 'naxal', 'jaishankar', 'rajnath', 'indian army', 'bsf', 'isro', 'drdo', 'loc'],
    searchAliases: ['india', 'indian', 'new delhi', 'modi', 'mumbai', 'bangalore', 'kashmir', 'ladakh', 'manipur', 'arunachal', 'jaishankar', 'rajnath'],
    baselineRisk: 25,
    eventMultiplier: 1.5,
  },
  PK: {
  ...
  BD: {
    name: 'Bangladesh',
    scoringKeywords: ['bangladesh', 'dhaka', 'bangladeshi'],
    searchAliases: ['bangladesh', 'bangladeshi', 'dhaka'],
    baselineRisk: 30,
    eventMultiplier: 1.5,
  },
  LK: {
    name: 'Sri Lanka',
    scoringKeywords: ['sri lanka', 'colombo', 'sri lankan'],
    searchAliases: ['sri lanka', 'sri lankan', 'colombo'],
    baselineRisk: 25,
    eventMultiplier: 1.2,
  },
  NP: {
    name: 'Nepal',
    scoringKeywords: ['nepal', 'kathmandu', 'nepali'],
    searchAliases: ['nepal', 'nepali', 'kathmandu'],
    baselineRisk: 20,
    eventMultiplier: 1.0,
  },
  SY: {
...
export const HOTSPOT_COUNTRY_MAP: Record<string, string | string[]> = {
  ...
  houston: 'US', cairo: 'EG', newdelhi: 'IN',
};
