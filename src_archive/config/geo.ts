...
export const INTEL_HOTSPOTS: Hotspot[] = [
  ...
  // South Asia hotspot
  {
    ...
    lon: 77.2,
    location: 'India',
    keywords: ['india', 'modi', 'delhi', 'kashmir', 'loc', 'ladakh', 'indian army', 'isro', 'drdo', 'raw', 'ib', 'nsa india', 'bsf', 'crpf', 'naxal', 'manipur', 'arunachal', 'jaishankar', 'rajnath', 'indian navy', 'indian air force', 'siachen', 'galwan', 'doklam', 'balakot'],
    agencies: ['RAW', 'IB', 'NSA (India)', 'DRDO', 'ISRO'],
    description: 'Indian intelligence and defence command center. Border tensions with Pakistan and China. Counter-terrorism operations.',
    status: 'Monitoring',
    escalationScore: 3,
    escalationTrend: 'stable',
    escalationIndicators: ['LAC standoff with China', 'LoC ceasefire monitoring', 'Counter-insurgency ops in NE India', 'Maritime expansion in Indian Ocean'],
    history: {
      lastMajorEvent: 'Galwan Valley clash',
      lastMajorEventDate: '2020-06-15',
      precedentCount: 5,
      precedentDescription: 'Kargil 1999, Parliament attack 2001, Mumbai 2008, Balakot strikes 2019, Galwan clash 2020',
      cyclicalRisk: 'Independence Day (Aug 15), Republic Day (Jan 26), election cycles',
    },
    whyItMatters: 'Nuclear-armed state; LAC standoff with China; LoC tensions with Pakistan; Indian Ocean security; key US strategic partner in Indo-Pacific',
  },
  {
    id: 'bangalore',
    name: 'Bangalore',
    subtext: 'IT/Defence Hub',
    lat: 12.97,
    lon: 77.59,
    location: 'Karnataka, India',
    keywords: ['bangalore', 'bengaluru', 'karnataka', 'hal', 'isro', 'drdo', 'it hub', 'silicon valley india', 'infosys', 'wipro'],
    agencies: ['HAL', 'ISRO', 'DRDO', 'BEL'],
    description: 'India\'s IT capital and defence aerospace hub. Home to HAL, ISRO, DRDO, BEL and major tech companies.',
    status: 'Monitoring',
  },
  {
    id: 'hyderabad',
    name: 'Hyderabad',
    subtext: 'Defence/Pharma Hub',
    lat: 17.38,
    lon: 78.49,
    location: 'Telangana, India',
    keywords: ['hyderabad', 'telangana', 'bhel', 'midhani', 'drdl', 'pharma', 'cyberabad'],
    agencies: ['BHEL', 'MIDHANI', 'DRDL'],
    description: 'India\'s defence research and pharmaceutical hub. Home to missile development, ordnance factories, and tech corridor.',
    status: 'Monitoring',
  },
  {
    id: 'mumbai',
    name: 'Mumbai',
    subtext: 'Financial Capital',
    lat: 19.08,
    lon: 72.88,
    location: 'Maharashtra, India',
    keywords: ['mumbai', 'bombay', 'maharashtra', 'bse', 'nse', 'rbi', 'sensex', 'nifty', 'dalal street', 'western naval command', 'mumbai attack'],
    agencies: ['RBI', 'SEBI', 'BSE', 'NSE', 'Western Naval Command'],
    description: 'India\'s financial capital. Home to RBI, BSE, NSE, and Western Naval Command. Key economic and maritime hub.',
    status: 'Monitoring',
    escalationScore: 2,
    escalationTrend: 'stable',
    escalationIndicators: ['Financial market activity', 'Western Naval Command operations', 'Counter-terrorism vigilance'],
    history: {
      lastMajorEvent: '26/11 Mumbai attacks',
      lastMajorEventDate: '2008-11-26',
      precedentCount: 3,
      precedentDescription: '1993 Bombay bombings, 2006 train bombings, 2008 Mumbai attacks',
      cyclicalRisk: 'Major festivals, financial events',
    },
    whyItMatters: 'India\'s economic nerve center; $4T+ market cap exchanges; Western Naval Command HQ; major terror attack target historically',
  },
];
