...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  bangalore: { name: 'Bangalore', enabled: true, priority: 1 },
  delhi: { name: 'Delhi', enabled: true, priority: 1 },
  hyderabad: { name: 'Hyderabad', enabled: true, priority: 1 },
  mumbai: { name: 'Mumbai', enabled: true, priority: 1 },
  'live-webcams': { name: 'Live Webcams', enabled: false, priority: 1 },
  flightradar: { name: 'Live Flight Radar', enabled: false, priority: 1 },
  insights: { name: 'AI Insights', enabled: true, priority: 1 },
  'strategic-posture': { name: 'AI Strategic Posture', enabled: true, priority: 3 },
  ...
  'oref-sirens': { name: 'Israel Sirens', enabled: false, priority: 3 },
...
export const PANEL_CATEGORY_MAP: Record<string, { labelKey: string; panelKeys: string[]; variants?: string[] }> = {
  ...
  regionalNews: {
    ...
    panelKeys: ['india', 'politics', 'us', 'europe', 'middleeast', 'africa', 'latam', 'asia'],
    variants: ['full'],
  },
  marketsFinance: {
