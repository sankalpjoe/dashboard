...
export const SOURCE_TIERS: Record<string, number> = {
  ...
  'AFP': 1,
  'Bloomberg': 1,
  // India Official OSINT
  'PIB India Defence': 1,
  'CERT-In Advisories': 1,
  'ReliefWeb India': 2,
...
const FULL_FEEDS: Record<string, Feed[]> = {
  ...
  india: [
    { name: 'India Conflict & Terror', url: rss('https://news.google.com/rss/search?q=India+(war+OR+attack+OR+terror+OR+militant+OR+insurgency+OR+Naxal+OR+Maoist+OR+Kashmir+OR+ceasefire+OR+border+clash+OR+crossfire+OR+encounter+OR+shootout)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Natural Disasters', url: rss('https://news.google.com/rss/search?q=India+(earthquake+OR+flood+OR+cyclone+OR+landslide+OR+tsunami+OR+drought+OR+wildfire+OR+avalanche+OR+cloudburst+OR+storm+OR+tornado+OR+sinkhole)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Bomb & Explosions', url: rss('https://news.google.com/rss/search?q=India+(bomb+threat+OR+bomb+blast+OR+explosion+OR+IED+OR+grenade+OR+hoax+bomb+OR+suspicious+package)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Disease & Health', url: rss('https://news.google.com/rss/search?q=India+(disease+outbreak+OR+epidemic+OR+pandemic+OR+dengue+OR+malaria+OR+cholera+OR+bird+flu+OR+Nipah+OR+swine+flu+OR+Zika+OR+food+poisoning+OR+hospital+fire)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Climate & Pollution', url: rss('https://news.google.com/rss/search?q=India+(heatwave+OR+cold+wave+OR+climate+emergency+OR+pollution+crisis+OR+smog+OR+water+crisis+OR+AQI+severe+OR+crop+failure+OR+famine)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Defence & Military', url: rss('https://news.google.com/rss/search?q=(Indian+Army+OR+Indian+Navy+OR+Indian+Air+Force+OR+India+military+OR+LOC+OR+LAC+OR+Siachen+OR+AFSPA+OR+surgical+strike+OR+India+China+border)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Protests & Unrest', url: rss('https://news.google.com/rss/search?q=India+(protest+OR+demonstration+OR+rally+OR+march+OR+bandh+OR+hartaal+OR+strike+OR+agitation+OR+dharna+OR+blockade+OR+shutdown)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Riots & Violence', url: rss('https://news.google.com/rss/search?q=India+(riot+OR+communal+violence+OR+mob+lynching+OR+curfew+OR+Section+144+OR+stabbing+OR+acid+attack+OR+arson+OR+stone+pelting)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Accidents', url: rss('https://news.google.com/rss/search?q=India+(train+accident+OR+road+accident+OR+bus+crash+OR+bridge+collapse+OR+building+collapse+OR+factory+fire+OR+mine+collapse+OR+stampede)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'India Cyber & Infrastructure', url: rss('https://news.google.com/rss/search?q=India+(cyber+attack+OR+data+breach+OR+power+outage+OR+blackout+OR+dam+breach+OR+oil+spill+OR+gas+leak+OR+chemical+leak)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    // Official India OSINT sources
    { name: 'PIB India Defence', url: rss('https://pib.gov.in/RssMain.aspx?ModId=6&Lang=1&Regid=3') },
    { name: 'CERT-In Advisories', url: rss('https://www.cert-in.org.in/RSS.jsp') },
    { name: 'ReliefWeb India', url: rss('https://reliefweb.int/updates/rss.xml?primary_country=119') },
  ],
  bangalore: [
    { name: 'Bangalore Threats', url: rss('https://news.google.com/rss/search?q=(Bangalore)+(bomb+threat+OR+attack+OR+explosion+OR+shooting+OR+terror+OR+suspicious+package)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Bangalore Disasters', url: rss('https://news.google.com/rss/search?q=(Bangalore+OR+Karnataka)+(flood+OR+earthquake+OR+landslide+OR+cyclone+OR+rain+fury+OR+fire+OR+building+collapse+OR+accident)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Bangalore Health', url: rss('https://news.google.com/rss/search?q=(Bangalore+OR+Karnataka)+(disease+OR+outbreak+OR+dengue+OR+hospital+emergency+OR+food+poisoning+OR+epidemic)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Bangalore Protests', url: rss('https://news.google.com/rss/search?q=(Bangalore)+(protest+OR+rally+OR+demonstration+OR+bandh+OR+strike+OR+agitation+OR+shutdown+OR+blockade)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Bangalore Crime', url: rss('https://news.google.com/rss/search?q=(Bangalore)+(riot+OR+violence+OR+murder+OR+crime+OR+curfew+OR+stabbing+OR+kidnap+OR+accident+OR+crash)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
  ],
  delhi: [
    { name: 'Delhi Threats', url: rss('https://news.google.com/rss/search?q=Delhi+(bomb+threat+OR+attack+OR+terror+OR+shooting+OR+explosion+OR+blast+OR+suspicious+package)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Delhi Pollution & Climate', url: rss('https://news.google.com/rss/search?q=Delhi+(pollution+OR+AQI+OR+smog+OR+heatwave+OR+cold+wave+OR+air+quality+emergency+OR+water+crisis+OR+Yamuna+pollution)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Delhi Disasters', url: rss('https://news.google.com/rss/search?q=Delhi+(flood+OR+earthquake+OR+fire+OR+building+collapse+OR+gas+leak+OR+short+circuit+OR+accident+OR+stampede)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Delhi Protests', url: rss('https://news.google.com/rss/search?q=Delhi+(protest+OR+rally+OR+demonstration+OR+march+OR+dharna+OR+Jantar+Mantar+OR+agitation+OR+blockade)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Delhi Crime & Violence', url: rss('https://news.google.com/rss/search?q=Delhi+(crime+OR+murder+OR+kidnapping+OR+riot+OR+violence+OR+curfew+OR+stabbing+OR+shootout+OR+gang+war)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
  ],
  hyderabad: [
    { name: 'Hyderabad Threats', url: rss('https://news.google.com/rss/search?q=(Hyderabad+OR+Telangana)+(bomb+threat+OR+attack+OR+fire+OR+explosion+OR+shooting+OR+terror)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Hyderabad Disasters', url: rss('https://news.google.com/rss/search?q=(Hyderabad+OR+Telangana)+(flood+OR+cyclone+OR+earthquake+OR+rain+fury+OR+landslide+OR+accident+OR+building+collapse)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Hyderabad Protests', url: rss('https://news.google.com/rss/search?q=(Hyderabad+OR+Telangana)+(protest+OR+rally+OR+bandh+OR+strike+OR+agitation+OR+demonstration+OR+shutdown)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Hyderabad Crime', url: rss('https://news.google.com/rss/search?q=(Hyderabad+OR+Telangana)+(riot+OR+communal+OR+violence+OR+murder+OR+crime+OR+curfew+OR+encounter)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Hyderabad Health', url: rss('https://news.google.com/rss/search?q=(Hyderabad+OR+Telangana)+(disease+OR+outbreak+OR+dengue+OR+epidemic+OR+hospital+emergency+OR+food+poisoning)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
  ],
  mumbai: [
    { name: 'Mumbai Threats', url: rss('https://news.google.com/rss/search?q=Mumbai+(bomb+threat+OR+attack+OR+terror+OR+explosion+OR+blast+OR+shooting+OR+suspicious+package)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Mumbai Disasters', url: rss('https://news.google.com/rss/search?q=(Mumbai+OR+Maharashtra)+(flood+OR+cyclone+OR+earthquake+OR+landslide+OR+building+collapse+OR+rain+OR+fire+OR+stampede)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Mumbai Protests', url: rss('https://news.google.com/rss/search?q=Mumbai+(protest+OR+rally+OR+demonstration+OR+bandh+OR+strike+OR+agitation+OR+shutdown+OR+blockade)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Mumbai Crime & Violence', url: rss('https://news.google.com/rss/search?q=Mumbai+(crime+OR+murder+OR+riot+OR+violence+OR+gang+OR+encounter+OR+stabbing+OR+kidnap)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
    { name: 'Mumbai Health', url: rss('https://news.google.com/rss/search?q=(Mumbai+OR+Maharashtra)+(disease+OR+outbreak+OR+epidemic+OR+dengue+OR+malaria+OR+hospital+crisis+OR+food+poisoning)+when:1d&hl=en-IN&gl=IN&ceid=IN:en') },
  ],
  gov: [
...
export const SOURCE_REGION_MAP: Record<string, { labelKey: string; feedKeys: string[] }> = {
  ...
  india: { labelKey: 'header.sourceRegionIndia', feedKeys: ['india'] },
  ...
  topical: { labelKey: 'header.sourceRegionTopical', feedKeys: ['energy', 'tech', 'ai', 'layoffs', 'thinktanks'] },
...
export const DEFAULT_ENABLED_SOURCES: Record<string, string[]> = {
  india: ['The Hindu', 'Indian Express', 'NDTV', 'Livemint', 'The Wire', 'The Print', 'Times of India', 'Hindustan Times', 'India Defence News', 'India Diplomacy'],
  ...
  asia: ['BBC Asia', 'The Diplomat', 'South China Morning Post', 'Reuters Asia', 'Nikkei Asia', 'CNA', 'Asia News'],
